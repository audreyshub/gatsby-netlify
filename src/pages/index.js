...
export default function Home() {
    return (<div class="content">
        ...
        <p class="answer">SSL/HTTPS is important because it protects server-client communication so that sensitive data like passwords and credit card numbers are protected against hackers. It verifies the authenticity of the website and helps gain user trust. And it improves search engine ranking.</p>
