...
export default function Home() {
    return (<div class="content">
        ...
        <p class="answer"><b>Least favorite ☺️:</b>
            <ol>
        ...
        <p class="answer">Hi there! Sorry to hear you’re having trouble with your build. </p>
        ...
        <p class="answer">With a little bit of more information we can help take a closer look. Thanks!</p>
        ...
        <p class="answer">On the job posting for APAC, the hours are listed as Monday through Friday, UTC+8-UTC+10. I believe that is an error as it appears there are only two hours in the shift 🕑? I also think sharing the salary range would be helpful with transparency.</p>
